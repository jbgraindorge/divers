...
[master-nodes]
'${master_node1}' ansible_ssh_user=ubuntu ansible_python_interpreter=/usr/bin/python3
'${master_node2}' ansible_ssh_user=ubuntu ansible_python_interpreter=/usr/bin/python3
[slave-nodes]
'${slave_node1}' ansible_ssh_user=ubuntu ansible_python_interpreter=/usr/bin/python3
'${slave_node2}' ansible_ssh_user=ubuntu ansible_python_interpreter=/usr/bin/python3
'${slave_node3}' ansible_ssh_user=ubuntu ansible_python_interpreter=/usr/bin/python3
EOF
